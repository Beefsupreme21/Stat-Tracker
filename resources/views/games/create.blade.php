<x-layout>
    <form action="/games" method="POST" class="border border-gray-200 max-w-[1200px] mx-auto mt-12 rounded-xl p-6">
        @csrf
        <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
            <div class="space-y-6 pt-8 sm:space-y-5 sm:pt-10">
                ...
                <div class="sm:grid sm:grid-cols-2 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
                    ...
                    <div class="mt-1 sm:col-span-1 sm:mt-0">
                        <input type="date" name="date" class="block w-full max-w-lg rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:max-w-xs sm:text-sm">
                    </div>
                </div>
                ...
                <div class="sm:grid sm:grid-cols-2 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
                    ...
                    <div class="mt-1 sm:col-span-1 sm:mt-0">
                        <input type="text" name="weather" id="weather" class="block w-full max-w-lg rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:max-w-xs sm:text-sm">
                    </div>
                </div>
                ...
                <div class="sm:grid sm:grid-cols-2 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
                    ...
                    <div class="mt-1 sm:col-span-1 sm:mt-0">
                        <input type="text" name="umpire" id="umpire" class="block w-full max-w-lg rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:max-w-xs sm:text-sm">
                    </div>
                </div>
